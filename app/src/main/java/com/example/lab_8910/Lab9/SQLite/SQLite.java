...
//            Toast.makeText(this, ten, Toast.LENGTH_SHORT).show();
    ...
    private void DialogThem(){
        ...
        btnThem.setOnClickListener(v -> {
            ...
            if(tencv.equals("")){
                Toast.makeText(SQLite.this, "Vui lòng nhập tên công việc !", Toast.LENGTH_SHORT).show();
            } else {
                database.QueryData("Insert into CongViec values(null, '" + tencv + "')");
                Toast.makeText(SQLite.this, "Đã thêm", Toast.LENGTH_SHORT).show();
    ...
    public void DialogSuaCongViec(String ten, int id){
        ...
        btnXacNhan.setOnClickListener(v -> {
            ...
            Toast.makeText(SQLite.this, "Đã cập nhật", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
            GetDataCongViec();
        });
    ...
    public void DialogXoaCongViec(String tencv, int Id){
        ...
        dialogXoa.setPositiveButton("Yes", (dialog, which) -> {
            ...
            Toast.makeText(SQLite.this, "Đã Xoá"+ tencv, Toast.LENGTH_SHORT).show();
            GetDataCongViec();
        });
