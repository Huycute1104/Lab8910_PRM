...
import com.example.lab_8910.Lab10.API.Adapter.TraineeListViewAdapter;
import com.example.lab_8910.Lab10.API.Model.Trainee;
import com.example.lab_8910.Lab10.API.Repository.TraineeRepository;
import com.example.lab_8910.Lab10.API.Service.TraineeService;
import com.example.lab_8910.Lab10.API.Util.ValidationUtils;
...
public class API extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        traineeAdapter = new TraineeListViewAdapter(API.this, traineeList, R.layout.row_trainee);
        listView.setAdapter(traineeAdapter);
        loadTrainees();
    }
    public void showDialog(DialogType dialogType, Trainee currentTrainee) {
        Dialog dialog = new Dialog(API.this);
        ...
        traineeService.getAllTrainees()
                .enqueue(new Callback<List<Trainee>>() {
                    ...
                    public void onFailure(Call<List<Trainee>> call, Throwable t) {
                        Toast.makeText(API.this, "An error has occurred!", Toast.LENGTH_SHORT).show();
                    }
                });
    }
            ...
            traineeService.deleteTrainee(traineeToDelete.getId())
                    .enqueue(new Callback<Trainee>() {
                        ...
                        public void onResponse(Call<Trainee> call, Response<Trainee> response) {
                            Toast.makeText(API.this, "Trainee " + traineeToDelete.getName() + " has been deleted!", Toast.LENGTH_SHORT).show();
    ...
    public void createTrainee(Trainee trainee) {
        traineeService.createTrainee(trainee)
                .enqueue(new Callback<Trainee>() {
                    @Override
                    public void onResponse(Call<Trainee> call, Response<Trainee> response) {
                        Toast.makeText(API.this, "Trainee " + trainee.getName() + " has been added!", Toast.LENGTH_SHORT).show();
    ...
    public void updateTrainee(Trainee currentTrainee, Trainee updateTrainee) {
        traineeService.updateTrainee(currentTrainee.getId(), updateTrainee)
                .enqueue(new Callback<Trainee>() {
                    @Override
                    public void onResponse(Call<Trainee> call, Response<Trainee> response) {
                        Toast.makeText(API.this, "Trainee has been updated!", Toast.LENGTH_SHORT).show();
