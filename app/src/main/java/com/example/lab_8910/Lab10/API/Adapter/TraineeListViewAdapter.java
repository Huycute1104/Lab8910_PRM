package com.example.lab_8910.Lab10.API.Adapter;
...
public class TraineeListViewAdapter extends BaseAdapter {
    ...
    private final API context;
    private List<Trainee> traineeList;
    private final int rowTraineeLayout;

    public TraineeListViewAdapter(API context, List<Trainee> traineeList, int rowTraineeLayout) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.icEdit.setOnClickListener(v -> context.showDialog(API.DialogType.UPDATE, trainee));
        return view;
    }
}
